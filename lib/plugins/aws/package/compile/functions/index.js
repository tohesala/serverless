        ...
        versionCompilationPromise = addFileContentsToHashes(artifactFilePath, [
          ...
          .then(() => {
            ...
            functionObject.targetAlias = {
              name: aliasResource.Properties.Name,
              logicalId: this.provider.naming.getLambdaAliasLogicalId(functionName),
            };
            ...
            if (functionObject.provisionedConcurrency) {
              ...
              functionObject.targetAlias.logicalId = this.provider.naming.getLambdaProvisionedConcurrencyAliasLogicalId(functionName);
            }
